...
import design.akililab.akilipocket.barcodedetection.BarcodeFieldAdapter.BarcodeFieldViewHolder
    ...
    internal class BarcodeFieldViewHolder private constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        companion object {
            ...
            fun create(parent: ViewGroup): BarcodeFieldViewHolder {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.qrcode_field, parent, false)
